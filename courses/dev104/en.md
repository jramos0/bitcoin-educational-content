---
name: Lightning App Development
...
<chapterId>b2151c76-2d4c-4647-9994-9b2fddf01eb9</chapterId>
mkdir hello-node
cd hello-node

## Initialize Node.js project
<chapterId>4ea661a2-e9e7-41b9-bf83-39aff6d4bc33</chapterId>
npm init -y

## Create main file
<chapterId>7b5c6c93-91c4-4ea6-b745-bb0a62690bc0</chapterId>
...
<chapterId>063b0e73-56ab-4cff-ba85-86f72913bcbb</chapterId>
npx package-name

## Or configure npm properly
<chapterId>a97b04f0-10bc-4900-84f7-b8987ed3922a</chapterId>
...
```bash
## Create project directory
<chapterId>782d3b4f-1821-4f9a-a0c2-1ac37dc5b0d1</chapterId>
mkdir pleb-wallet-backend
cd pleb-wallet-backend

## Initialize Node.js project
<chapterId>9ec7e826-8aa5-407f-b3db-454237694a48</chapterId>
npm init -y

## Create main server file
<chapterId>5e63bc5c-d907-42e7-aced-477f264a6e9c</chapterId>
touch index.js

## Install Express
<chapterId>2a9caf20-3e99-4830-832a-e6cbf7afe3ba</chapterId>
npm install express
```
...
<chapterId>5ff7a21a-ec3b-4a49-ad5a-c5e1b9cfa720</chapterId>
lsof -ti:5500 | xargs kill -9

## Or use a different port
<chapterId>a053e8a0-78c8-4d27-9006-63226dc7fed1</chapterId>
...
```bash
## Install dotenv
<chapterId>060563a0-2519-48a7-8718-8e6680f5fa1e</chapterId>
npm install dotenv
```
...
<chapterId>1eb575a9-63c2-496c-aaad-e0a530d3194d</chapterId>
npm install -g nodemon

## Or install locally
<chapterId>35b94e14-7433-4984-9d99-d89b4202b248</chapterId>
...
<chapterId>1c4d1296-4a47-43a1-a100-a55875fd939c</chapterId>
PORT=5500

## JWT Secret (use a strong, random string in production)
<chapterId>13a9dd6e-0259-48b7-9c3b-303001bb414e</chapterId>
JWT_SECRET=keepitsecretkeepitsafe

## Admin key for elevated permissions
<chapterId>4c6bb8cc-4992-44f9-a23c-cae2f4d65073</chapterId>
ADMIN_KEY=1234
```
...
<chapterId>0e744ef1-551a-43d5-af14-0a3208a08a49</chapterId>
...
<chapterId>99d51e08-80ea-4d56-b0d8-2e94246d769f</chapterId>
## Then install Polar from the website
<chapterId>ec644ef8-fb96-478c-a0bc-d10607bdca00</chapterId>
```
...
<chapterId>0847e1e3-f60b-438b-a8c0-3a57f8dc294c</chapterId>
...
<chapterId>ed7ef020-bae7-40f7-9768-29d60def6a59</chapterId>
git clone https://github.com/plebdevs/pleb-wallet-frontend.git
cd pleb-wallet-frontend

## Install dependencies
<chapterId>e9ed0233-b4ae-4e32-88e1-aa2fad8f3a45</chapterId>
npm install
```
...
```bash
## .env file
<chapterId>954a9005-a062-4f88-ac1c-d77c4eb0a873</chapterId>
...
<chapterId>a75b9e87-2313-4bdd-9bbe-4b899b7e112b</chapterId>
## Open Docker Desktop
<chapterId>5339ae36-7abd-42c8-b54d-8a68dfa8afc4</chapterId>
## Start Polar and your Lightning network
<chapterId>9c3dece5-ba1a-47c8-a3bd-1438269bdc9b</chapterId>

## Terminal 2: Start Backend
<chapterId>ddad4529-8a21-4fb6-a5cc-f59556fe6a5d</chapterId>
cd pleb-wallet-backend
npm run start

## Terminal 3: Start Frontend
<chapterId>89815e81-4bea-4f9c-b74c-0dc47e3acc4a</chapterId>
cd pleb-wallet-frontend
npm start
```
...
```bash
## Production .env
<chapterId>53f3c97a-35e0-4e22-83ad-8c8b6cc7961c</chapterId>
...
<chapterId>80a9469c-80d1-4341-88ae-71c204735417</chapterId>
npm run build

## This creates a 'build' folder with optimized static files
<chapterId>7f27e3f0-324c-4849-b9e3-d633e855e6ce</chapterId>
```
...
```bash
## Create a user
<chapterId>20586de1-2193-4db8-b234-62a83fee69c5</chapterId>
...
## Login
<chapterId>80a56c2f-135f-4153-9c5c-ba840d031d2e</chapterId>
...
<chapterId>2b071ac3-e349-4529-80ef-195562335b3e</chapterId>
...
```bash
## Create admin user
<chapterId>4c68e723-e623-40d8-9733-44f80700468a</chapterId>
POST https://your-app-name.herokuapp.com/users/register
{
  "username": "admin",
...
## Login and get users
<chapterId>13f93b05-1923-44fa-b4df-71699fb83c0c</chapterId>
POST https://your-app-name.herokuapp.com/users/login
GET https://your-app-name.herokuapp.com/users
```
...
<chapterId>64255b2f-3b36-45f0-8e6f-1104193dd890</chapterId>
openssl rand -base64 32

## Generate secure JWT secret
<chapterId>59680fa6-a9e7-4ff7-aab9-4635199b1046</chapterId>
...
```bash
## View live logs
<chapterId>34773e5d-a9d8-42a2-ab8b-9556618e1f0f</chapterId>
heroku logs --tail --app your-app-name

## View specific number of lines
<chapterId>7af0985f-1fe8-4fec-9809-baea762ce49c</chapterId>
...
<chapterId>a92694d6-ed66-4593-a9fd-198c06dd26c9</chapterId>
heroku pg:backups:capture --app your-app-name

## List backups
<chapterId>53d8fedd-0d25-4c26-8ca4-fdb73fd8cd12</chapterId>
heroku pg:backups --app your-app-name

## Download backup
<chapterId>a95d9c21-60ab-4130-8819-8fa013342601</chapterId>
